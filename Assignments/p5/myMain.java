...
public class myMain {
 ...
 //    }
    ...
    {
    	MinHeap<String> heap = new MinHeap(9);

    	String[] arr = new String[]{"5", "3", "10", "14", "16", "7", "1", "1"};

    	My.cout("arr:\t" + My.arrayToString(arr) );
    	...
    	My.cout("heap:\t" + My.arrayToString(heap.toArray()) );

    	for(int i=0;i<=arr.length;i++){
    		My.cout("top: "+heap.removeMin());
    		// My.cout("initTop:\t"+heap.removeMin()+"\tCurrSize:\t"+heap.currSize()+"\tCurrTop:\t"+heap.peek());
    		My.cout("heap:\t" + My.arrayToString(heap.toArray()) );
    	}
